...
<div>
                <div class="register">
					...
					<h1 align="center" class="style13">Register Here</h1>
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email" placeholder="Please Enter Email" required>
                                               ...
                                               <div class="form-group">
                            <label><span class="style3">Password</span></label>
                            <input type="password" class="form-control" name="password" placeholder="Please Enter Password" maxlength="15" required>
                        </div>
                        <div class="form-group">
                            <label><span class="style3">Confirm Password</span></label>
                            <input type="password" class="form-control" name="confirmPassword" placeholder="Please Re-enter Password" maxlength="15" required>
                        </div>
						<div class="form-group" align="center">
                        <button type="submit" class="btn btn-primary" name="register">
                        <div align="center" class="style14">Register</div>
                        </button>
						</div>
                    </form>
					<div class="text-center">
	  <div align="center"><span class="style15">Already have an account?</span> <a href="login.php" class="style16">Login here</a></div>
	</div>
                </div>
               </div>
</div>
